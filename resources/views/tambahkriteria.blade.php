...
@section('content')
<body>
    <h1 class="text-center mb-4">TAMBAH DATA KRITERIA</h1>
    ...
    <div class="container">
        <div class="row justify-content-center">
           <div class="col-8">
            <div class="card">
                <div class="card-body">
                 <form action="/insertkriteria" method="POST" enctype="multipart/form-data">
                    @csrf
                    <h3 class="text-center mb-4">TAMBAH DATA KRITERIA</h3>
                     <div class="mb-3">
                     ...
                     <div class="mb-3">
                        ...
                        <input type="float" name="bobot_kriteria" class="form-control" id="exampleInputEmail1" aria-describedby="emailHelp">
