    ...
    <div class="container">
      ...
      <div class="row g-3 align-items-center mt-2">
        ...
        <table class="table table-striped table-bordered">
          ...
          @if(auth()->user()->name == 'admin')
          <td><center>
            <a href="/detailsdata/{{$row->id}}" class="btn btn-info btn-sm">Detail</a>
            <a href="/tampilkandatasurvey/{{$row->id}}" class="btn btn-warning btn-sm">Edit</a>
            <a href="#" class="btn btn-danger delete_warga btn-sm" data-id="{{$row->id}}" data-nama="{{$row->nama}}">Delete</a>
          </center>
        </td>
        @endif
      </tr>      
